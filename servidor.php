...
$menu = [
  ...
  ['titulo'=>"Coisa",'link'=>"#mapa"]
];

$dados = [
  ['titulo'=>"Cartão Teste", 'descricao'=>"Descrição do cartão 1", 'detalhe'=>"Texto de detalhe do cartão 1", 'imagem'=>"http://materializecss.com/images/office.jpg", 'link'=>"#link"],
